                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-light">
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu">
                                <li><a href="page-venue.php"> Venue</a></li>
                                    
                               <li><a href="page-photography.php"> Photography </a>
                                </li>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    ...
                    <div class="p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center">
                        ...
                        <div class="content mt-7">
                            ...
                            <div class="mt-5">
                                <a href="addvenue.php" class="btn btn-link text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Add venue<i class="uil uil-arrow-right"></i></a>
...
<?php
     ...
     $result =$mysqli->query("select *from venue") or die($mysqli->error);
   //  pre_r($result);
    ...
    <table >
          ...
          while($row=$result->fetch_assoc()):?>
               <tr>
                    ...
                    <td><img height ="40" width="40" src='<?php echo $row['venue_image'];?>'></td> 
                   <td>
                         <a href="productupdate.php?edit=<?php echo $row['venue_id']; ?>"
                              class="btn btn-info">Edit</a>
                              <a href="process.php?delete=<?php echo $row['venue_id'];?>"
     ...
     endwhile;?>
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 pb-8 items-end">
                    <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold"> Projects & Works</h3>
                    <p class="text-slate-400 max-w-xl">Explore and learn more.</p>
                </div><!--end grid-->
            </div><!--end container-->
                        ...
                        <div class="tiny-slide">
                            <div class="group relative block overflow-hidden rounded-md transition-all duration-500 mx-2">
                                <a href="assets/images/portfolio/1.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                    <img src='<?php echo $row['venue_image'];?>' class="" alt="work-image">
                                </a>
