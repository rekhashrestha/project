...
<html lang="en" class="light scroll-smooth" dir="ltr">
    ...
    <!-- <body class="font-nunito text-base text-black dark:text-white dark:bg-slate-900"> -->
            ...
            <div class="container">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-light">
                        <li><a href="userview" class="sub-menu-item">Home</a></li>
                            ...
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
                                        ...
                                        <li><a href="serviceview.php" class="sub-menu-item">Venues</a></li>
                                        <li><a href="userview.php" class="sub-menu-item">Photography</a></li>
        ...
        <!-- Start Hero -->
        <section class="relative table w-full py-32 lg:py-36 bg-[url('../../assets/images/real/bg/01.jpg')] bg-no-repeat bg-center">
            <div class="absolute inset-0 bg-black opacity-80"></div>
            <div class="container">
                <div class="grid grid-cols-1 text-center mt-10">
                    <h3 class="md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">Welcome &#128591</h3>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
        <div class="relative">
 ...
 <?php
          ...
          while($row=$result->fetch_assoc()):?>
                    <div class="group rounded-md bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-800 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                        ...
                        <div class="relative">
                            <img src="<?php echo $row['venue_image'];?>" alt="">
                        ...
                        <div class="p-6">
                            <div class="pb-6">
                                <a href="property-detail.html" class="text-lg hover:text-indigo-600 font-medium ease-in-out duration-500"><?php echo $row['name'];?></a>
                            </div>
                            ...
                            <ul class="pt-6 flex justify-between items-center list-none">
                                <li>
                                    ...
                                    <p class="text-lg font-medium"><?php echo $row['price'];?></p>
                                </li>
                        ...
                        <div class="lg:mt-6">
                        <a href="booking.php?edit=<?php echo $row['venue_id']; ?>"
                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white searchbtn submit-btn w-full !h-12 rounded">Book Now</a>
                            ...
                            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                                ...
                                <div class="lg:col-span-2 md:col-span-4">
                                    ...
                                    <ul class="list-none footer-list mt-6">
                                        <li><a href="about us.php" class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> About us</a></li>
                                        <li class="mt-[10px]"><a href="serviceview.php" class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Services</a></li>
